...
"[project]/hooks/use-sensor-data.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$sensor$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/use-sensor-data.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function TrendsPage() {
    const { currentData, historyData, loading, connected } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$sensor$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSensorData"])();
    const selectedSensor = currentData?.sensor_keys?.[0] || "Temperature";
    const sensor = SENSOR_CONFIG[selectedSensor];
    const transformedHistoryData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>calculateStats(transformedHistoryData), [
        transformedHistoryData
    ]);
    const trend = (Number.parseFloat(stats.current) - Number.parseFloat(stats.mean)) / 10;
    const forecastData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>generateForecastData(transformedHistoryData, trend), [
        transformedHistoryData,
        trend
    ]);
    const histogramData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>generateHistogramData(stats.min, stats.max), [
        stats.min,
        stats.max
    ]);
...
//# sourceMappingURL=_4403df95._.js.map