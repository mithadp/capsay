...
function AnalyticsPage() {
    ...
    const fetchSensorData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AnalyticsPage.useCallback[fetchSensorData]": async ()=>{
            try {
                ...
                if (result.history && typeof result.history === "object") {
                    const historyArray = Object.entries(result.history).map({
                        "AnalyticsPage.useCallback[fetchSensorData].historyArray": ([, item])=>({
                                ...item,
                    ...
                    }["AnalyticsPage.useCallback[fetchSensorData].historyArray"]).slice(-50);
    ...
    }["AnalyticsPage.useCallback[fetchSensorData]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AnalyticsPage.useEffect": ()=>{
            fetchSensorData();
            const interval = setInterval(fetchSensorData, 5000);
            return ({
                "AnalyticsPage.useEffect": ()=>clearInterval(interval)
            })["AnalyticsPage.useEffect"];
        }
    }["AnalyticsPage.useEffect"], [
        fetchSensorData
...
_s(AnalyticsPage, "qsspChijdOJ03y4ciCM8LmBT7wY=");
_c = AnalyticsPage;
var _c;
...
//# sourceMappingURL=app_%28dashboard%29_analytics_page_tsx_4a54c2ba._.js.map