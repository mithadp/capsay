...
function OverviewPage() {
    ...
    const fetchSensorData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OverviewPage.useCallback[fetchSensorData]": async ()=>{
            try {
                setError("");
                const controller = new AbortController();
                const timeoutId = setTimeout({
                    "OverviewPage.useCallback[fetchSensorData].timeoutId": ()=>controller.abort()
                }["OverviewPage.useCallback[fetchSensorData].timeoutId"], 8000);
                ...
                if (result.history && typeof result.history === "object") {
                    const historyArray = Object.entries(result.history).map({
                        "OverviewPage.useCallback[fetchSensorData].historyArray": ([, item])=>({
                                ...item,
                    ...
                    }["OverviewPage.useCallback[fetchSensorData].historyArray"]).slice(-30);
    ...
    }["OverviewPage.useCallback[fetchSensorData]"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OverviewPage.useEffect": ()=>{
            ...
            const connectSSE = {
                "OverviewPage.useEffect.connectSSE": ()=>{
                    try {
                        eventSource = new EventSource("/api/stream");
                        eventSource.onmessage = ({
                            "OverviewPage.useEffect.connectSSE": (event)=>{
                                try {
                                    ...
                                    if (data.latest) {
                                        ...
                                        if (result.history && typeof result.history === "object") {
                                            const historyArray = Object.entries(result.history).map({
                                                "OverviewPage.useEffect.connectSSE.historyArray": ([, item])=>({
                                                        ...item,
                                                        timestamp: new Date(item.timestamp || Date.now()).toLocaleTimeString("id-ID", {
                                                            hour: "2-digit",
                                                            minute: "2-digit"
                                            ...
                                            }["OverviewPage.useEffect.connectSSE.historyArray"]).slice(-30);
                                            setHistoryData(historyArray);
                                        }
                                        setLastUpdate(new Date().toLocaleTimeString("id-ID", {
                                            hour: "2-digit",
...
_s(OverviewPage, "KscnmxJWGsFd/Z7pVJula1+zYmw=");
_c = OverviewPage;
var _c;
...
//# sourceMappingURL=app_%28dashboard%29_overview_page_tsx_c2fecc91._.js.map